function [m_matrixNew,valueMax,connect,value]=dostepSynchronous(m_matrix,rowVal,columnVal,discount)
    [M,N] =  size(m_matrix);
    ...
    if m_matrix(rowVal,columnVal).blocked == true
        ...
        gij = -costOpenCell(M);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        [connect,~,update,valueMax]= doSynchronous(m_matrix,rowVal,columnVal,discount); 
...
%                 m_matrix = findAndConnectPatches(m_matrix);
    ...
    %If the current cell is not blocked
          ...
          [connect,value,update,valueMax]= doSynchronous(m_matrix,rowVal,columnVal,discount);
...
function [connect,combinationValue, update, valueMax] = doSynchronous(m_matrix,rowVal,columnVal,discount)
